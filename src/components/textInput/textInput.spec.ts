...
describe("text input component", () => {
    it("Should be able to work properly with v-model on parent", async () => {
        const parent = {
            template: `<TextInput v-model="inputValue" labelText="Testing model" inputId="TestInput"  />`,
    ...
    it("Should be able to receive label and placeholder props", () => {
        const parent = {
            template: `<TextInput v-model="inputValue" labelText="Testing model" inputId="TestInput" placeholder="Test placeholder" />`,
            components: { TextInput },
            data() {
                return { inputValue: "" }
            }
